  ...
  return (
    <div className="partnership-form-detail">
      <form noValidate autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
        {isEmailSentFund ? (
          <p className="grey">
            Thank you for sahring you interest in partnering with SelectQuote. A
          ...
          <>
                      ...
                      render={({
                        ...
                        <>
                          ...
                          {error && (
                            <span
                              style={{
                                marginTop: isDesktop(screenMode)
                                  ? "42px"
                                  : "100px",
                              }}
                            >
                        ...
                        <>
                          ...
                          {error && (
                            <span
                              className="mt-40"
                              style={{
                                marginTop: !isDesktop(screenMode) && "40px",
                              }}
                            >
                              Please select an option
                            </span>
            ...
            <div
              className={`row ${!isDesktop(screenMode) ? "mt-55" : "top-space"} 
                  `}
            >
              <div className="col">
                <label className="form-label grey  mb-15">
                    ...
                    <Controller
                      ...
                      render={({
                        ...
                        <>
                          <input
                            type="radio"
                            checked={selectedRadio1 === "Others1"}
                            onChange={(e) => {
                              onChange(e);
                              setSelectedRadio1(e.target.value);
                            }}
            ...
            >
              <label
                className={`form-label grey ${
                  !isDesktop(screenMode) ? "mb-30" : "mb-0"
                } 
                  `}
              >
            ...
            <div className="row top-space large-input">
              <label
                className={`form-label grey ${
                  !isDesktop(screenMode) ? "mb-35" : "mb-30"
                } 
                  `}
              >
                <b>
              ...
              <div className="col">
                <UseFormTextField
                  control={control}
                  type={isDesktop(screenMode) ? "text" : "textarea"}
                  name="volume"
                  placeholder="Volume "
                />
              </div>
            ...
            <div
              className={`row large-input ${
                !isDesktop(screenMode) ? "mt-55" : "top-space"
              } 
                  `}
            >
              <label
            ...
            >
              <div className="col">
                <label
                  className={`form-label grey ${
                    !isDesktop(screenMode) ? "mb-5" : "mb-15"
                  } 
                  `}
                >
                  <b>
                ...
                <ul className="custom-radio simple-radio">
                  <li
                    className="mb-5"
                    style={{ width: isDesktop(screenMode) ? "50%" : "100%" }}
                  >
                    <Controller
                      name="radiooption3"
                      control={control}
                      render={({
                        ...
                        <>
                          <input
                            ...
                            name="radioOption3"
                          />
                          <label className="grey radius-30">
                            Owned & Operated
                          </label>
                          {error && (
                            <span
            ...
            <div
              className={`row large-input ${
                !isDesktop(screenMode) ? "mt-55" : "mt-100"
              } 
                  `}
            >
              <label
                    ...
                    <Controller
                      ...
                      render={({
                        ...
                        <>
                          <input
                            type="radio"
                            checked={selectedRadio2 === "Others2"}
                            onChange={(e) => {
                              onChange(e);
                              setSelectedRadio2(e.target.value);
                            }}
