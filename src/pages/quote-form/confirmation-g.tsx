...
export default ({ quoteForm }: { quoteForm: TypeComponent_Quote_Form }) => {
    ...
    useEffect(() => {
        ...
        if (storageData) {
            ...
            const conditions =
                storageData?.life_preexisting_conditions?.split(',')
    ...
    useEffect(() => {
        ...
        if (storageData) {
            const email = storageData?.primary_email
            const fname = storageData?.firstName
            setEmail(email)
            setFirstName(fname)
        }
    }, [])
    ...
    return (
        <Layout page={quoteForm} header={header} footer={footer}>
            ...
            <section className="confirmation-g d-flex flex-column align-items-center justify-content-center">
                <div className="thank-you container wp-container d-flex flex-column align-items-center justify-content-center text-center">
                    <div className="confirmation-message">
                        <h1>
                            Thank you, {firstName}! Your quote is being
                            processed.
                        </h1>
                        <p>
